...
RUN cd /root/DST/bin  \
    && echo "/root/steamcmd/steamcmd.sh +@ShutdownOnFailedCommand 1 +@NoPromptForPassword 1 +force_install_dir +login anonymous /root/DST +app_update 343050 +quit" > start.sh \
...
EXPOSE 11000-11001/udp 27018-27019/udp
